                           ...
                           <details>
                               ...
                               <table>
                                   ...
                                   <xsl:for-each select="$content//map">
                                       ...
                                       <tr>
                                           <td><a><xsl:attribute name="href">https://github.com/<xsl:value-of select="$repoName"/>/blob/main/data_structure/<xsl:value-of select="substring-after(@file, '/data_line/')"/></xsl:attribute><xsl:value-of select="@key2"/></a></td>
