...
if test -f "mets.xml"; then
    ...
    cd /home/runner/work/example-gt-repo/example-gt-repo/data/${PWD##*/};ocrd zip bag -i ocrd_data_structur_${PWD##*/} -I ocrd_data_structur_${PWD##*/};find -name ocrd_data_structur_${PWD##*/};sudo mv /home/runner/work/example-gt-repo/example-gt-repo/data/*.zip /home/runner/work/example-gt-repo/example-gt-repo/ocrdzip_out/
